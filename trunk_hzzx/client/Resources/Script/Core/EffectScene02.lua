...
-- 初始
function EffectScene02:onInit(parentNode)
	-- 内层粒子
	...
	Utils:createShader(seaWaveSprite, "common.vsh", "water_wave.fsh")
...
-- 销毁
function EffectScene02:onDestroy()
