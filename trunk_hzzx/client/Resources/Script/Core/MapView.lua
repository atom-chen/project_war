...
function MapView:onTouch(touch, event, eventCode)
	...
	if cc.EventCode.BEGAN == eventCode and not self.mIsInTouch then
		self.mIsInTouch = true
		self:onTouchBegan(touch, event, gridInfo)
	elseif cc.EventCode.MOVED == eventCode and self.mIsInTouch then
		self:onTouchMoved(touch, event, gridInfo)
	elseif cc.EventCode.ENDED == eventCode and self.mIsInTouch then
		self:onTouchEnded(touch, event, gridInfo)
		self.mIsInTouch = false
	elseif cc.EventCode.CANCELLED == eventCode and self.mIsInTouch then
