...
-- 连线更新
function EffectLine:update(lineCount)
	if self.sprite then
		if lineCount < 6 then
			self.sprite:setScaleX(1)
		elseif lineCount >= 6 and lineCount < 10 then
			self.sprite:setScaleX(1.2)
		elseif lineCount >= 10 and lineCount < 15 then
			self.sprite:setScaleX(1.4)
		elseif lineCount >= 15 then
			self.sprite:setScaleX(1.6)
		end
	end
end
