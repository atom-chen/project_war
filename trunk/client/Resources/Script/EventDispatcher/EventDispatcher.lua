...
function CreateEventDispatcher()
	...
	function dispathcer:subscribe(eventId, func, target, priority)
		...
		if nil == handlers then
			handlers = {}
			table.insert(handlers, {func = func, target = target, priority = priority or #handlers})
		...
		table.insert(mEventHandlerMap[eventId], {func = func, target = target, priority = priority or #handlers})
