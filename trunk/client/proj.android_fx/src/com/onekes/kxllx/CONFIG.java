...
public class CONFIG {
	...
	// 对话框正常图�?
	//public static final int DIALOG_NORMAL_ICON = R.drawable.info;
	// 对话框错误图�?
	//public static final int DIALOG_ERROR_ICON = R.drawable.infoicon;
    ...
    public static final String WX_APP_ID = "wx4ba3a089ed823555";
    
    // 商家向财付通申请的商家id
    public static final String WX_PARTNER_ID = "1234350402";
    ...
    public static final String WX_APP_KEY = "OnekesXM5191370YZX8210501LUXIANG"; // wx4ba3a089ed823555 对应的支付密钥
    
    public static final String FX_APP_KEY = "ce783ca99d8bcb80db2713fe23600527";
}
