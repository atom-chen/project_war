...
public class RoundImageView extends ImageView {
	...
	private void setCustomAttributes(AttributeSet attrs) {
		...
		mBorderThickness = a.getDimensionPixelSize(
				R.styleable.roundedimageview_border_cicle_thickness, 0);
		mBorderOutsideColor = a
				.getColor(R.styleable.roundedimageview_border_outside_cicle_color,
						defaultColor);
		mBorderInsideColor = a.getColor(
				R.styleable.roundedimageview_border_inside_cicle_color, defaultColor);
	}
