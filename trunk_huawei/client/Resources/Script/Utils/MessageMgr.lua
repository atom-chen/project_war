...
----------------------------------------------------------------------
-- 初始化消息管理器
function MessageMgr:init(historyMsgSize)
	mMsgTable = {}
...
----------------------------------------------------------------------
-- 插入一条消息
function MessageMgr:insertMsg(priority, msgtype, times, data, limitCount)
...
----------------------------------------------------------------------
-- 获取历史消息队列
function MessageMgr:getHistoryMsg()
