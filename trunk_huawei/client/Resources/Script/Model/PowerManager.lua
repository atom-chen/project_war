...
local function timer1_CF1(tm, runCount)
	...
	PowerManger:setLeftTime(leftTime)
	EventDispatcher:post(EventDef["ED_POWER_LEFT_TIME"], leftTime)
end
...
local function timer1_CF2(tm)
	...
	--抽奖界面时，更新体力
	GetRewardModel:setCurRewardPower(PowerManger:getCurPower())
...
function PowerManger:pushNotify()
	...
	ChannelProxy:addNotify(2, 2, LanguageStr(msgKey), leftTime)
end
