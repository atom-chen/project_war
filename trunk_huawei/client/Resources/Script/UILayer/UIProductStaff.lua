...
function UIProductStaff:onStart(ui, param)
	...
	self.mScrollView = UIManager:seekNodeByName(self.ui.root, "ScrollView_1")
...
function UIProductStaff:initEvent()
	--关闭按钮
	local btnClose = UIManager:seekNodeByName(self.ui.root, "Button_close")
